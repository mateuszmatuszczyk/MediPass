...
<body>
			...
			<div class="navbar-header">
				...
				<ul class="user-menu">
					<li class="dropdown pull-right">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg><?php echo $physicianName." ".$physicianSurname;?><span class="caret"></span></a>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="ph_prescription.php"><svg class="glyph stroked male-user"><use xlink:href="#stroked-pencil"></use></svg> Prescriptions</a></li>
			<li><a href="ph_statistics.php"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-line-graph"></use></svg> Statistics</a></li>
			<li class="active"><a href="ph_schedule.php"><svg class="glyph stroked app-window"><use xlink:href="#stroked-app-window"></use></svg> Alerts &amp; Panels</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			...
			<div id="notification" class="alert bg-success" role="alert">
					<svg class="glyph stroked checkmark"><use xlink:href="#stroked-checkmark"></use></svg> Medical Record Added <a href="#" class="pull-right"></a>
				</div>
		<div class="row">
			<div class="col-lg-12">
