...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="ph_prescription.php"><svg class="glyph stroked male-user"><use xlink:href="#stroked-pencil"></use></svg> Prescriptions</a></li>
			<li><a href="ph_statistics.php"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-line-graph"></use></svg> Statistics</a></li>
			<li><a href="ph_schedule.php"><svg class="glyph stroked app-window"><use xlink:href="#stroked-app-window"></use></svg> Alerts &amp; Panels</a></li>
